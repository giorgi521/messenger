...
import { fullCoverstationType } from '@/app/types';
...
const ConversationBox:React.FC<ConversationBoxProps> = ({
   ...
   if(!lastMessage){
    ...
    return (
        <div onClick={handleClick} className={clsx(`w-full relative flex px-2 items-center space-x-3 hover:bg-neutral-100 rounded-lg transition cursor-pointer`,
